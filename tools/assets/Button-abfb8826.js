import{H as E,d as ee,b3 as Se,an as Be,n as B,af as Te,b1 as Pe,R as p,G as b,aI as ke,b7 as oe,ai as Re,J as x,ax as l,az as J,ay as He,L as re,al as Ie,aj as Ee,b as R,K as Oe,aX as _e,aO as Fe,N as r,aw as H,O as De,aD as U,b8 as je,aC as Ne,aE as Ke,S as Ge,aF as Me}from"./index-7f7898e7.js";import{i as O}from"./is-browser-fc34c9a6.js";import{u as Ve}from"./use-form-item-f6bb8cbd.js";import{c as Z}from"./color-to-class-b0332f36.js";const We=E("base-wave",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
...
`),qe=ee({name:"BaseWave",props:{clsPrefix:{type:String,required:!0}},setup(e){Se("-base-wave",We,Be(e,"clsPrefix"));const f=B(null),h=B(!1);let u=null;return Te(()=>{u!==null&&window.clearTimeout(u)}),{active:h,selfRef:f,play(){u!==null&&(window.clearTimeout(u),h.value=!1,u=null),Pe(()=>{var v;(v=f.value)===null||v===void 0||v.offsetHeight,h.value=!0,u=window.setTimeout(()=>{h.value=!1,u=null},1e3)})}}},render(){const{clsPrefix:e}=this;return p("div",{ref:"selfRef","aria-hidden":!0,class:[`${e}-base-wave`,this.active&&`${e}-base-wave--active`]})}}),{cubicBezierEaseInOut:C}=ke;function Qe({duration:e=".2s",delay:f=".1s"}={}){return[b("&.fade-in-width-expand-transition-leave-from, &.fade-in-width-expand-transition-enter-to",{opacity:1}),b("&.fade-in-width-expand-transition-leave-to, &.fade-in-width-expand-transition-enter-from",`
 ...
 margin-left ${e} ${C},
 margin-right ${e} ${C};
 `)]}const Ae=O&&"chrome"in window;O&&navigator.userAgent.includes("Firefox");const Le=O&&navigator.userAgent.includes("Safari")&&!Ae;function $(e){return oe(e,[255,255,255,.16])}function I(e){return oe(e,[0,0,0,.12])}const Xe=Re("n-button-group"),Ye=b([E("button",`
 margin: 0;
 ...
 `,[x("active",{zIndex:1,animationName:"button-wave-spread, button-wave-opacity"})]),O&&"MozBoxSizing"in document.createElement("div").style?b("&::moz-focus-inner",{border:0}):null,l("border, state-border",`
 position: absolute;
 left: 0;
 top: 0;
 right: 0;
